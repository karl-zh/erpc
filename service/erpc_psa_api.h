/*
 * Generated by erpcgen 1.7.1 on Tue Jul 30 21:33:39 2019.
 *
...
struct psa_invec
{
    int32_t base;        /*!< the start address of the memory buffer */
...
//! @name PsaCallService
//@{
psa_status_t psa_call(psa_handle_t handle, uint32_t TYPE, uint32_t in_vec, uint32_t in_len, uint32_t out_vec, uint32_t out_len);
//@} 
